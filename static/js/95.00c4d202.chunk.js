"use strict";(globalThis.webpackChunkina=globalThis.webpackChunkina||[]).push([[95],{4530(e,t,a){a.d(t,{A:()=>p});var n=a(5043),r=a(403),i=a(5402),o=a(579);const s=r.i7`
  0% {
...
`,d=r.Ay.div`
  ...
  overflow-x: hidden;
  pointer-events: none;
`,p=e=>{let{freeFloat:t=!1,zIndex:a}=e;const[r,s]=(0,n.useState)([]),p=(0,n.useRef)(null),x=(0,n.useRef)(null),[h]=(0,n.useState)(!t);(0,n.useEffect)(()=>{i.A.forEach(e=>{(new Image).src=`/takos/${encodeURIComponent(e)}`})},[]),(0,n.useEffect)(()=>{const e=()=>{const e=Math.floor(3*Math.random())+1,t=document.documentElement.scrollHeight,a=[];for(let n=0;n<e;n++)Math.random()<.6&&a.push({key:Date.now()+Math.random()+n,left:h?c():90*Math.random(),tako:i.A[Math.floor(Math.random()*i.A.length)],bottom:Math.random()*t,createdAt:Date.now()});a.length>0&&s(e=>[...e,...a])},t=()=>{p.current=setInterval(e,1e3)},a=()=>{p.current&&clearInterval(p.current)},n=()=>"hidden"===document.visibilityState?a():t();return t(),document.addEventListener("visibilitychange",n),()=>{a(),document.removeEventListener("visibilitychange",n)}},[]),(0,n.useEffect)(()=>{const e=setInterval(()=>{s(e=>e.filter(e=>Date.now()-e.createdAt<9e3))},1e3);return()=>clearInterval(e)},[]);const c=()=>Math.random()<.5?10*Math.random():90+10*Math.random(),g=()=>{x.current&&(x.current.volume=.2,x.current.currentTime=0,x.current.play())};return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("audio",{ref:x,src:"/inatakosound.mp3",preload:"auto",style:{display:"none"}}),(0,o.jsx)(d,{$zIndex:a,children:r.map(e=>(0,o.jsx)(l,{left:e.left,bottom:e.bottom,src:`/takos/${encodeURIComponent(e.tako)}`,alt:"floating takodachi",onClick:g,style:{pointerEvents:"auto",cursor:"pointer"}},e.key))})]})}},1095(e,t,a){a.r(t),a.d(t,{default:()=>He});var n=a(5043),r=a(403),i=a(2582);const o=r.i7`
...
`;var d=a(579);const{rE:p}={rE:"26.2.3"},x=()=>(0,d.jsxs)(s,{children:[(0,d.jsx)(l,{children:(0,d.jsx)("img",{alt:"Ao-chan Logo",src:"/AOPatternFilledIn.png"})}),(0,d.jsx)("div",{className:"footer-social-container",children:(0,d.jsxs)("div",{className:"social-links",children:[(0,d.jsx)("a",{href:"https://twitter.com/ninomaeinanis",target:"_blank",rel:"noopener noreferrer",children:(0,d.jsxs)("p",{children:[(0,d.jsx)("i",{className:"fa fa-twitter"})," @ninomaeinanis"]})}),(0,d.jsx)("br",{}),(0,d.jsx)("a",{href:"https://www.youtube.com/channel/UCMwGHR0BTZuLsmjY_NT5Pwg",target:"_blank",rel:"noopener noreferrer",children:(0,d.jsxs)("p",{children:[(0,d.jsx)("i",{className:"fa fa-youtube-play"})," Ninomae Ina'nis Ch."]})})]})}),(0,d.jsx)("div",{className:"footer-img-container",children:(0,d.jsx)(i.N_,{to:"/credits",children:(0,d.jsx)("img",{alt:"mini-ina",className:"footer-img",src:"/MiniIna.png"})})}),(0,d.jsxs)("div",{className:"disclaimer-container",children:[(0,d.jsx)("p",{children:"This is a fan project. We are not affiliated with or endorsed by Cover Corporation."}),(0,d.jsxs)("p",{style:{fontSize:"0.75rem",opacity:.5,marginTop:"0.25rem"},children:["v",p]})]})]}),h=r.Ay.div`
  min-height: 100vh;
  position: relative;
  z-index: 1;
...
`;var y=a(3403);const b={Standard:"",Violet:"violet",Meconopsis:"meconopsis",Temari:"temari",TakoTakover:"tako8takover"},w=["0","1","cookies","uhh-i-think-she-needs-help"],v=r.i7`
...
`,$=[31,36,29,33],A=[6,22,0,14],T=r.Ay.img`
  ...
  animation: ${v} ${e=>{let{$delay:t}=e;return 2.6+.35*t}}s ease-in-out infinite;
  animation-delay: ${e=>{let{$delay:t}=e;return.45*t}}s;
`,M=()=>{const{theme:e}=(0,y.D)(),{mvFiles:t,shapedFiles:a,pos:r}=(0,n.useMemo)(()=>{const t=e=>(Math.random()-.5)*e+"%",a=(e,t)=>`${Math.floor(Math.random()*(t-e)+e)}px`,n=(e,t)=>`${Math.floor(Math.random()*(t-e)+e)}%`;return{mvFiles:"Standard"===e?["meconopsis","violet","temari","tako8takover"]:Array(4).fill(b[e]),shapedFiles:[...w].sort(()=>Math.random()-.5),pos:{mvLT:t(20),mvLB:t(20),mvRT:t(20),mvRB:t(20),mvGapLT:a(8,28),mvGapLB:a(8,28),mvGapRT:a(8,28),mvGapRB:a(8,28),shTopLT:n(-20,0),shTopLB:n(55,78),shTopRT:n(-20,0),shTopRB:n(55,78),shGapLT:a(130,210),shGapLB:a(120,200),shGapRT:a(130,210),shGapRB:a(120,200)}}},[e]),i=e=>`/balloons/mv/balloon-mv-${e}.png`,o=e=>`/balloons/takos/balloon-takos-${e}.png`;return(0,d.jsxs)(h,{children:[(0,d.jsxs)(f,{children:[(0,d.jsx)(g,{children:"Tentacult Temple Fan Site"}),(0,d.jsx)(I,{children:t.map((e,t)=>(0,d.jsx)(T,{src:i(e),alt:"",$delay:t,$index:t},t))}),(0,d.jsxs)(k,{children:[(0,d.jsx)(j,{$side:"left",$top:`calc(0%  + ${r.mvLT})`,$gap:r.mvGapLT,$delay:0,src:i(t[0]),alt:""}),(0,d.jsx)(j,{$side:"left",$top:`calc(45% + ${r.mvLB})`,$gap:r.mvGapLB,$delay:1,src:i(t[1]),alt:""}),(0,d.jsx)(j,{$side:"right",$top:`calc(5%  + ${r.mvRT})`,$gap:r.mvGapRT,$delay:2,src:i(t[2]),alt:""}),(0,d.jsx)(j,{$side:"right",$top:`calc(40% + ${r.mvRB})`,$gap:r.mvGapRB,$delay:3,src:i(t[3]),alt:""}),(0,d.jsx)(c,{alt:"ina-logo",src:"/InaLogo.png"}),(0,d.jsx)(j,{$side:"left",$top:r.shTopLT,$gap:r.shGapLT,$delay:4,src:o(a[0]),alt:""}),(0,d.jsx)(j,{$side:"left",$top:r.shTopLB,$gap:r.shGapLB,$delay:5,src:o(a[1]),alt:""}),(0,d.jsx)(j,{$side:"right",$top:r.shTopRT,$gap:r.shGapRT,$delay:6,src:o(a[2]),alt:""}),(0,d.jsx)(j,{$side:"right",$top:r.shTopRB,$gap:r.shGapRB,$delay:7,src:o(a[3]),alt:""})]}),(0,d.jsx)(m,{children:"INA'S 6TH ANNIVERSARY CELEBRATION"})]}),(0,d.jsx)(u,{children:(0,d.jsxs)("h3",{children:[(0,d.jsx)("i",{className:"fa fa-chevron-down"})," Scroll down for more"," ",(0,d.jsx)("i",{className:"fa fa-chevron-down"})]})})]})},z=r.Ay.div`
  text-align: center;
  padding-top: 10px;
  padding-bottom: 10px;
...
`,_=(0,r.Ay)(K)`
  ...
  ${e=>{let{$active:t}=e;return t&&r.AH`
...
`,pe=r.Ay.button`
  ...
  margin: 0;
  position: relative;
  ${e=>{let{$shaking:t}=e;return t&&r.AH`
      animation: ${re} 0.4s linear;
    `}}
  @media only screen and (max-width: 1100px) {
    max-width: 180px;
    max-height: 180px;
...
`,ge=r.Ay.a`
  ...
  align-items: center;
  justify-content: center;
`;var me=a(5402);const fe=[{to:"/momentsgallery",label:"Moments Gallery"},{to:"/wahrld",label:"Ina around the WAHrld"},{to:"/playlist",label:"The Ultimate Ina Playlist"},{to:"/inaoutfit",label:"Ina Ina Outfit!"},{to:"/timeline",label:"Ina's Timeline"},{to:"/takodex",label:"Takodex"},{to:"/messages",label:"Artworks & Messages"},{to:"/letters",label:"Letters for Ina"},{href:"Ina Cookbook.pdf",label:"Tako Cookbook"},{to:"/collages",label:"Takollages"},{to:"/moments",label:"Ina Moments (2024)"},{to:"/wah",label:"WAH (2024)"}],ue=["Ina Ina Outfit!","Moments Gallery","Ina around the WAHrld"],ye=["The Ultimate Ina Playlist","Ina's Timeline","Takodex","Takollages"],be=()=>{const[e,t]=(0,n.useState)(null),[a,r]=(0,n.useState)(""),[i,o]=(0,n.useState)(null);return(0,d.jsx)(ie,{children:(0,d.jsxs)(oe,{children:[(0,d.jsx)(H.wA,{children:(0,d.jsxs)("div",{className:"Menu-text",children:[(0,d.jsxs)("p",{children:["This site was developed by the ",(0,d.jsx)("b",{children:"Tentacult"})," to celebrate"," ",(0,d.jsx)("b",{children:"Ina's milestones"}),"!"]}),(0,d.jsxs)("p",{children:["It is ",(0,d.jsx)("b",{children:"TAKOTIME"})," to celebrate your"," ",(0,d.jsx)("b",{children:"6th debut anniversary"}),", Ina!!"]}),(0,d.jsxs)("p",{children:["This time, we collected all sorts of things from all over, from artwork to photos! From the world to you, takos share their support!! ",(0,d.jsx)("b",{children:"World Domination!!"})," In the"," ",(0,d.jsx)("b",{children:"Ina Around the WAHld"})," section, takos showed that we are everywhere!! ",(0,d.jsx)("b",{children:"WE ARE HERE!!"})]}),(0,d.jsxs)("p",{children:["We made tributes for all the amazing and fun moments that we spent over these six years. These can be found in the"," ",(0,d.jsx)("b",{children:"Moment Gallery"})," so we can remember them forever. Each moment is like a piece of art made by you, your friends, and us, and we will all cherish them always."]}),(0,d.jsxs)("p",{children:["Of course, as always, there are updates to other pages of the site as well! New outfits illustrated by talented takos, new song entries in the playlist, a timeline that is now up to date, and new tako variants registered in the ",(0,d.jsx)("b",{children:"Takodex"}),"!"]}),(0,d.jsxs)("p",{children:["Things have changed so much as the years have gone by, but you will always have our support. We couldn't be prouder to be"," ",(0,d.jsx)("b",{children:"Takodachis"}),", since we have such an amazing ",(0,d.jsx)("b",{children:"priestess"}),"."]}),(0,d.jsxs)("p",{children:[(0,d.jsx)("b",{children:"From many takos around the world, thank you so much!"}),(0,d.jsx)("br",{}),(0,d.jsx)("b",{children:"With all our love, Happy Anniversary, Ina! \ud83d\udc9c\ud83d\udc19"})]})]})}),(0,d.jsx)(se,{children:fe.map((n,s)=>(0,d.jsxs)(le,{onMouseEnter:()=>{t(s),(e=>{o(e),setTimeout(()=>o(null),400),r(""),setTimeout(()=>{const e=me.A[Math.floor(Math.random()*me.A.length)];r(`/takos/${encodeURIComponent(e)}`)},120)})(s)},onMouseLeave:()=>t(null),style:{position:"relative"},children:[ue.includes(n.label)&&(0,d.jsx)(ne,{children:"New!"}),ye.includes(n.label)&&(0,d.jsx)(ne,{children:"Update!"}),(0,d.jsx)(de,{className:"tako-peek",src:a,alt:"peeking tako",active:e===s&&!!a,style:{visibility:a?"visible":"hidden"}}),"to"in n?(0,d.jsx)(ce,{to:n.to,role:"button",children:(0,d.jsxs)(pe,{title:n.label,$shaking:i===s,children:[(0,d.jsx)(xe,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(he,{children:n.label})]})}):(0,d.jsx)(ge,{href:n.href,role:"button",target:"Takollages"===n.label?"_blank":void 0,rel:"Takollages"===n.label?"noopener noreferrer":void 0,children:(0,d.jsxs)(pe,{title:n.label,$shaking:i===s,children:[(0,d.jsx)(xe,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(he,{children:n.label})]})})]},n.label))})]})})},we=60,ve=r.Ay.div`
...
`,ke=r.Ay.img`
  ...
  animation: ${e=>{let{mirror:t}=e;return(e=>r.i7`
  from {
...
`,je=e=>{let{mirror:t,topGap:a}=e;return(0,d.jsx)(ve,{$topGap:a,children:Array(8).fill(0).map((e,a)=>(0,d.jsx)(ke,{src:"/takoflap.gif",alt:"gif",delay:-1.25*a,mirror:t,draggable:"false"},a))})};var Ie=a(1472),$e=a(2154),Ae=a(4530);const Te=e=>({src:`balloons/generic/balloon-generic-${e}.png`}),Me=e=>({src:`balloons/mv/balloon-mv-${e}.png`}),ze=e=>({src:`balloons/takos/balloon-takos-${e}.png`}),Se=[ze("0"),ze("1"),ze("cookies"),ze("uhh-i-think-she-needs-help")],Ye={Standard:[Me("meconopsis"),Me("violet"),Me("temari"),Me("tako8takover"),Te("purple"),Te("pink"),Te("white"),Te("yellow"),Te("fushia"),Te("orange"),Te("green"),Te("lime"),...Se],Violet:[Me("violet"),Te("blue"),Te("blueagain"),Te("violet"),Te("sky"),Te("cyan"),Te("purple"),...Se],Meconopsis:[Me("meconopsis"),Te("blue"),Te("blueagain"),Te("cyan"),Te("purple"),Te("sky"),Te("violet"),...Se],Temari:[Me("temari"),Te("red"),Te("lightred"),Te("orange"),Te("pink"),Te("fushia"),Te("yellow"),...Se],TakoTakover:[Me("tako8takover"),Te("purple"),Te("fushia"),Te("pink"),Te("violet"),Te("sky"),...Se]},Ne=r.Ay.img`
  ...
  pointer-events: none;
  will-change: transform;
  animation: ${e=>{let{swayOffset:t}=e;return r.AH`
    ${(e=>r.i7`
  0% {
...
`,Re=r.Ay.div`
  ...
  overflow: visible;
  overflow-x: hidden;
`,Ce=()=>{const[e,t]=(0,n.useState)([]),a=(0,n.useRef)(null),{theme:r}=(0,y.D)();return(0,n.useEffect)(()=>{Ye[r].forEach(e=>{(new Image).src=`/${e.src}`})},[r]),(0,n.useEffect)(()=>{const e=()=>{const e=Ye[r],a=Math.floor(2*Math.random())+1,n=document.documentElement.scrollHeight,i=[];for(let t=0;t<a;t++)if(Math.random()<.96){const a=e[Math.floor(Math.random()*e.length)],r=10*Math.random()+8;i.push({key:Date.now()+Math.random()+t,left:Math.random()*(100-r-6),src:a.src,bottom:Math.random()*n,createdAt:Date.now(),heightScale:.6*Math.random()+.4,swayOffset:(30*Math.random()+10)*(Math.random()<.5?1:-1)})}i.length>0&&t(e=>[...e,...i])},n=()=>{a.current=setInterval(e,2e3)},i=()=>{a.current&&clearInterval(a.current)},o=()=>"hidden"===document.visibilityState?i():n();return n(),document.addEventListener("visibilitychange",o),()=>{i(),document.removeEventListener("visibilitychange",o)}},[r]),(0,n.useEffect)(()=>{const e=setInterval(()=>{t(e=>e.filter(e=>Date.now()-e.createdAt<2e4))},2e3);return()=>clearInterval(e)},[]),(0,d.jsx)(Re,{children:e.map(e=>(0,d.jsx)(Ne,{left:e.left,bottom:e.bottom,swayOffset:e.swayOffset,$heightScale:e.heightScale,src:`/${e.src}`,alt:"floating balloon"},e.key))})},Ee=r.Ay.div`
  position: relative;
  width: 100%;
  max-width: 100vw;
  overflow-x: hidden;
