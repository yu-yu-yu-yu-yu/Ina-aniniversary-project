"use strict";(globalThis.webpackChunkina=globalThis.webpackChunkina||[]).push([[95],{4530(e,t,a){a.d(t,{A:()=>p});var n=a(5043),i=a(403),o=a(5402),r=a(579);const s=i.i7`
  0% {
...
`,d=i.Ay.div`
  ...
  overflow-x: hidden;
  pointer-events: none;
`,p=e=>{let{freeFloat:t=!1,zIndex:a}=e;const[i,s]=(0,n.useState)([]),p=(0,n.useRef)(null),h=(0,n.useRef)(null),[x]=(0,n.useState)(!t);(0,n.useEffect)(()=>{o.A.forEach(e=>{(new Image).src=`/takos/${encodeURIComponent(e)}`})},[]),(0,n.useEffect)(()=>{const e=()=>{const e=Math.floor(3*Math.random())+1,t=document.documentElement.scrollHeight,a=[];for(let n=0;n<e;n++)Math.random()<.6&&a.push({key:Date.now()+Math.random()+n,left:x?c():90*Math.random(),tako:o.A[Math.floor(Math.random()*o.A.length)],bottom:Math.random()*t,createdAt:Date.now()});a.length>0&&s(e=>[...e,...a])},t=()=>{p.current=setInterval(e,1e3)},a=()=>{p.current&&clearInterval(p.current)},n=()=>"hidden"===document.visibilityState?a():t();return t(),document.addEventListener("visibilitychange",n),()=>{a(),document.removeEventListener("visibilitychange",n)}},[]),(0,n.useEffect)(()=>{const e=setInterval(()=>{s(e=>e.filter(e=>Date.now()-e.createdAt<9e3))},1e3);return()=>clearInterval(e)},[]);const c=()=>Math.random()<.5?10*Math.random():90+10*Math.random(),g=()=>{h.current&&(h.current.volume=.2,h.current.currentTime=0,h.current.play())};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("audio",{ref:h,src:"/inatakosound.mp3",preload:"auto",style:{display:"none"}}),(0,r.jsx)(d,{$zIndex:a,children:i.map(e=>(0,r.jsx)(l,{left:e.left,bottom:e.bottom,src:`/takos/${encodeURIComponent(e.tako)}`,alt:"floating takodachi",onClick:g,style:{pointerEvents:"auto",cursor:"pointer"}},e.key))})]})}},1095(e,t,a){a.r(t),a.d(t,{default:()=>Le});var n=a(5043),i=a(403),o=a(2582);const r=i.i7`
...
`;var y=a(3403);const b={Standard:"",Violet:"violet",Meconopsis:"meconopsis",Temari:"temari",TakoTakover:"tako8takover"},w=["0","1","cookies","uhh-i-think-she-needs-help"],v=i.i7`
...
`;var L=a(984);const H=Array.from({length:47},(e,t)=>`valkyrie_illust_vids/val-${t+1}.mp4`),G=e=>{if(1===H.length)return H[0];let t=e;for(;t===e;){const e=Math.floor(Math.random()*H.length);t=H[e]}return t},B=()=>{const[e,t]=(0,n.useState)(()=>G()),[a,i]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i(!1)},[e]);const o=(0,n.useCallback)(()=>{t(e=>G(e))},[]),r=(0,n.useCallback)(()=>{i(!0)},[]);return(0,d.jsx)(z,{children:(0,d.jsxs)(S,{children:[(0,d.jsx)(L.wA,{children:(0,d.jsxs)("div",{className:"lore-text",children:[(0,d.jsx)("hr",{}),(0,d.jsxs)("p",{children:["One day, ",(0,d.jsx)("b",{children:"Ina'nis"})," picked up a ",(0,d.jsx)("b",{children:"strange book"})," and then started to gain the power of ",(0,d.jsx)("b",{children:"controlling tentacles"}),". To her, ",(0,d.jsx)("b",{children:"tentacles"})," are just a part in her ordinary life; it has never been a big deal for her. However, her girly mind does want to get them",(0,d.jsx)("b",{children:" dressed up and stay pretty"}),"."]}),(0,d.jsxs)("p",{children:["After gaining power, she started hearing"," ",(0,d.jsx)("b",{children:"Ancient Whispers and Revelations"}),". Hence, she began her"," ",(0,d.jsx)("b",{children:"VTuber activities "})," to deliver ",(0,d.jsx)("b",{children:" random sanity checks "})," ","on humanity, as an ",(0,d.jsx)("b",{children:"ordinary girl"}),"."]}),(0,d.jsx)("hr",{})]})}),(0,d.jsxs)(Y,{style:{background:a?"transparent":"var(--dark-background)"},children:[(0,d.jsx)(N,{autoPlay:!0,loop:!0,muted:!0,preload:"auto",onCanPlay:r,style:{opacity:a?1:0,transition:"opacity 0.5s ease"},children:(0,d.jsx)("source",{src:`/${e}`,type:"video/mp4"})},e),(0,d.jsx)(R,{type:"button",onClick:o,"aria-label":"Change lore video",title:"Change video",children:(0,d.jsx)("i",{className:"fa fa-refresh","aria-hidden":"true"})}),(0,d.jsx)(C,{children:(0,d.jsx)(E,{children:"Illustration and Animation: @valkyrie_illust"})})]})]})})},D=i.Ay.div`
...
`,_=(0,i.Ay)(K)`
  background: #e9d5ff;
  color: #2a1d3a;
  animation: ${U} 0.4s ease-in-out;

  ${e=>{let{$active:t}=e;return t&&i.AH`
      animation: ${F} 3s ease-in-out 1;
      box-shadow:
...
`,ge=i.Ay.a`
  ...
  align-items: center;
  justify-content: center;
`;var me=a(5402);const fe=[{to:"/momentsgallery",label:"Moments Gallery"},{to:"/wahrld",label:"Ina around the WAHrld"},{to:"/playlist",label:"The Ultimate Ina Playlist"},{to:"/inaoutfit",label:"Ina Ina Outfit!"},{to:"/timeline",label:"Ina's Timeline"},{to:"/takodex",label:"Takodex"},{to:"/messages",label:"Artworks & Messages"},{to:"/letters",label:"Letters for Ina"},{href:"Ina Cookbook.pdf",label:"Tako Cookbook"},{to:"/collages",label:"Takollages"},{to:"/moments",label:"Ina Moments (2024)"},{to:"/wah",label:"WAH (2024)"}],ue=["Ina Ina Outfit!","Moments Gallery","Ina around the WAHrld"],ye=["The Ultimate Ina Playlist","Ina's Timeline","Takodex","Takollages"],be=()=>{const[e,t]=(0,n.useState)(null),[a,i]=(0,n.useState)(""),[o,r]=(0,n.useState)(null);return(0,d.jsx)(oe,{children:(0,d.jsxs)(re,{children:[(0,d.jsx)(L.wA,{children:(0,d.jsxs)("div",{className:"Menu-text",children:[(0,d.jsxs)("p",{children:["This site was developed by the ",(0,d.jsx)("b",{children:"Tentacult"})," to celebrate"," ",(0,d.jsx)("b",{children:"Ina's milestones"}),"!"]}),(0,d.jsxs)("p",{children:["It is ",(0,d.jsx)("b",{children:"TAKOTIME"})," to celebrate your"," ",(0,d.jsx)("b",{children:"6th debut anniversary"}),", Ina!!"]}),(0,d.jsxs)("p",{children:["This time, we collected all sorts of things from all over, from artwork to photos! From the world to you, takos share their support!! ",(0,d.jsx)("b",{children:"World Domination!!"})," In the"," ",(0,d.jsx)("b",{children:"Ina Around the WAHld"})," section, takos showed that we are everywhere!! ",(0,d.jsx)("b",{children:"WE ARE HERE!!"})]}),(0,d.jsxs)("p",{children:["We made tributes for all the amazing and fun moments that we spent over these six years. These can be found in the"," ",(0,d.jsx)("b",{children:"Moment Gallery"})," so we can remember them forever. Each moment is like a piece of art made by you, your friends, and us, and we will all cherish them always."]}),(0,d.jsxs)("p",{children:["Of course, as always, there are updates to other pages of the site as well! New outfits illustrated by talented takos, new song entries in the playlist, a timeline that is now up to date, and new tako variants registered in the ",(0,d.jsx)("b",{children:"Takodex"}),"!"]}),(0,d.jsxs)("p",{children:["Things have changed so much as the years have gone by, but you will always have our support. We couldn't be prouder to be"," ",(0,d.jsx)("b",{children:"Takodachis"}),", since we have such an amazing ",(0,d.jsx)("b",{children:"priestess"}),"."]}),(0,d.jsxs)("p",{children:[(0,d.jsx)("b",{children:"From many takos around the world, thank you so much!"}),(0,d.jsx)("br",{}),(0,d.jsx)("b",{children:"With all our love, Happy Anniversary, Ina! \ud83d\udc9c\ud83d\udc19"})]})]})}),(0,d.jsx)(se,{children:fe.map((n,s)=>(0,d.jsxs)(le,{onMouseEnter:()=>{t(s),(e=>{r(e),setTimeout(()=>r(null),400),i(""),setTimeout(()=>{const e=me.A[Math.floor(Math.random()*me.A.length)];i(`/takos/${encodeURIComponent(e)}`)},120)})(s)},onMouseLeave:()=>t(null),style:{position:"relative"},children:[ue.includes(n.label)&&(0,d.jsx)(ne,{children:"New!"}),ye.includes(n.label)&&(0,d.jsx)(ne,{children:"Update!"}),(0,d.jsx)(de,{className:"tako-peek",src:a,alt:"peeking tako",active:e===s&&!!a,style:{visibility:a?"visible":"hidden"}}),"to"in n?(0,d.jsx)(ce,{to:n.to,role:"button",children:(0,d.jsxs)(pe,{title:n.label,$shaking:o===s,children:[(0,d.jsx)(he,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(xe,{children:n.label})]})}):(0,d.jsx)(ge,{href:n.href,role:"button",target:"Takollages"===n.label?"_blank":void 0,rel:"Takollages"===n.label?"noopener noreferrer":void 0,children:(0,d.jsxs)(pe,{title:n.label,$shaking:o===s,children:[(0,d.jsx)(he,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(xe,{children:n.label})]})})]},n.label))})]})})},we=60,ve=i.Ay.div`
...
`,je=e=>{let{mirror:t,topGap:a}=e;return(0,d.jsx)(ve,{$topGap:a,children:Array(8).fill(0).map((e,a)=>(0,d.jsx)(ke,{src:"/takoflap.gif",alt:"gif",delay:-1.25*a,mirror:t,draggable:"false"},a))})};var $e=a(1472),Ie=a(2154),Ae=a(4530);const Te=e=>({src:`balloons/generic/balloon-generic-${e}.png`}),Me=e=>({src:`balloons/mv/balloon-mv-${e}.png`}),ze=e=>({src:`balloons/takos/balloon-takos-${e}.png`}),Se=[ze("0"),ze("1"),ze("cookies"),ze("uhh-i-think-she-needs-help")],Ye={Standard:[Me("meconopsis"),Me("violet"),Me("temari"),Me("tako8takover"),Te("purple"),Te("pink"),Te("white"),Te("yellow"),Te("fushia"),Te("orange"),Te("green"),Te("lime"),...Se],Violet:[Me("violet"),Te("blue"),Te("blueagain"),Te("violet"),Te("sky"),Te("cyan"),Te("purple"),...Se],Meconopsis:[Me("meconopsis"),Te("blue"),Te("blueagain"),Te("cyan"),Te("purple"),Te("sky"),Te("violet"),...Se],Temari:[Me("temari"),Te("red"),Te("lightred"),Te("orange"),Te("pink"),Te("fushia"),Te("yellow"),...Se],TakoTakover:[Me("tako8takover"),Te("purple"),Te("fushia"),Te("pink"),Te("violet"),Te("sky"),...Se]},Ne=i.Ay.img`
  position: absolute;
  left: ${e=>{let{left:t}=e;return t}}vw;
  bottom: ${e=>{let{bottom:t}=e;return t}}px;
...
`,Re=i.Ay.div`
  ...
  overflow: visible;
  overflow-x: hidden;
`,Ce=()=>{const[e,t]=(0,n.useState)([]),a=(0,n.useRef)(null),{theme:i}=(0,y.D)();return(0,n.useEffect)(()=>{Ye[i].forEach(e=>{(new Image).src=`/${e.src}`})},[i]),(0,n.useEffect)(()=>{const e=()=>{const e=Ye[i],a=Math.floor(2*Math.random())+1,n=document.documentElement.scrollHeight,o=[];for(let t=0;t<a;t++)if(Math.random()<.96){const a=e[Math.floor(Math.random()*e.length)],i=10*Math.random()+8;o.push({key:Date.now()+Math.random()+t,left:Math.random()*(100-i-6),src:a.src,bottom:Math.random()*n,createdAt:Date.now(),heightScale:.6*Math.random()+.4,swayOffset:(30*Math.random()+10)*(Math.random()<.5?1:-1)})}o.length>0&&t(e=>[...e,...o])},n=()=>{a.current=setInterval(e,2e3)},o=()=>{a.current&&clearInterval(a.current)},r=()=>"hidden"===document.visibilityState?o():n();return n(),document.addEventListener("visibilitychange",r),()=>{o(),document.removeEventListener("visibilitychange",r)}},[i]),(0,n.useEffect)(()=>{const e=setInterval(()=>{t(e=>e.filter(e=>Date.now()-e.createdAt<2e4))},2e3);return()=>clearInterval(e)},[]),(0,d.jsx)(Re,{children:e.map(e=>(0,d.jsx)(Ne,{left:e.left,bottom:e.bottom,swayOffset:e.swayOffset,$heightScale:e.heightScale,src:`/${e.src}`,alt:"floating balloon"},e.key))})},Ee=i.Ay.div`
  position: relative;
  width: 100%;
  max-width: 100vw;
  overflow-x: hidden;
