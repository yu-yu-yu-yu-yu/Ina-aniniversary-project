"use strict";(globalThis.webpackChunkina=globalThis.webpackChunkina||[]).push([[421],{4530(e,t,a){a.d(t,{A:()=>p});var n=a(5043),i=a(403),o=a(5402),r=a(579);const l=i.i7`
  0% {
...
`;var d=a(579);const p=()=>(0,d.jsxs)(l,{children:[(0,d.jsx)(s,{children:(0,d.jsx)("img",{alt:"Ao-chan Logo",src:"/AOPatternFilledIn.png"})}),(0,d.jsx)("div",{className:"footer-social-container",children:(0,d.jsxs)("div",{className:"social-links",children:[(0,d.jsx)("a",{href:"https://twitter.com/ninomaeinanis",target:"_blank",rel:"noopener noreferrer",children:(0,d.jsxs)("p",{children:[(0,d.jsx)("i",{className:"fa fa-twitter"})," @ninomaeinanis"]})}),(0,d.jsx)("br",{}),(0,d.jsx)("a",{href:"https://www.youtube.com/channel/UCMwGHR0BTZuLsmjY_NT5Pwg",target:"_blank",rel:"noopener noreferrer",children:(0,d.jsxs)("p",{children:[(0,d.jsx)("i",{className:"fa fa-youtube-play"})," Ninomae Ina'nis Ch."]})})]})}),(0,d.jsx)("div",{className:"footer-img-container",children:(0,d.jsx)(o.N_,{to:"/credits",children:(0,d.jsx)("img",{alt:"mini-ina",className:"footer-img",src:"/MiniIna.png"})})}),(0,d.jsx)("div",{className:"disclaimer-container",children:(0,d.jsx)("p",{children:"This is a fan project. We are not affiliated with or endorsed by Cover Corporation."})})]}),x=i.Ay.div`
  min-height: 100vh;
  position: relative;
  z-index: 1;
...
`;var u=a(3403);const y={Standard:"",Violet:"violet",Meconopsis:"meconopsis",Temari:"temari",TakoTakover:"tako8takover"},b=["0","1","cookies","uhh-i-think-she-needs-help"],v=i.i7`
...
`,$=[31,36,29,33],A=[6,22,0,14],M=i.Ay.img`
  ...
  animation: ${v} ${e=>{let{$delay:t}=e;return 2.6+.35*t}}s ease-in-out infinite;
  animation-delay: ${e=>{let{$delay:t}=e;return.45*t}}s;
`,z=()=>{const{theme:e}=(0,u.D)(),{mvFiles:t,shapedFiles:a,pos:i}=(0,n.useMemo)(()=>{const t=e=>(Math.random()-.5)*e+"%",a=(e,t)=>`${Math.floor(Math.random()*(t-e)+e)}px`,n=(e,t)=>`${Math.floor(Math.random()*(t-e)+e)}%`;return{mvFiles:"Standard"===e?["meconopsis","violet","temari","tako8takover"]:Array(4).fill(y[e]),shapedFiles:[...b].sort(()=>Math.random()-.5),pos:{mvLT:t(20),mvLB:t(20),mvRT:t(20),mvRB:t(20),mvGapLT:a(8,28),mvGapLB:a(8,28),mvGapRT:a(8,28),mvGapRB:a(8,28),shTopLT:n(-20,0),shTopLB:n(55,78),shTopRT:n(-20,0),shTopRB:n(55,78),shGapLT:a(130,210),shGapLB:a(120,200),shGapRT:a(130,210),shGapRB:a(120,200)}}},[e]),o=e=>`/balloons/mv/balloon-mv-${e}.png`,r=e=>`/balloons/takos/balloon-takos-${e}.png`;return(0,d.jsxs)(x,{children:[(0,d.jsxs)(g,{children:[(0,d.jsx)(h,{children:"Tentacult Temple Fan Site"}),(0,d.jsx)(j,{children:t.map((e,t)=>(0,d.jsx)(M,{src:o(e),alt:"",$delay:t,$index:t},t))}),(0,d.jsxs)(w,{children:[(0,d.jsx)(k,{$side:"left",$top:`calc(0%  + ${i.mvLT})`,$gap:i.mvGapLT,$delay:0,src:o(t[0]),alt:""}),(0,d.jsx)(k,{$side:"left",$top:`calc(45% + ${i.mvLB})`,$gap:i.mvGapLB,$delay:1,src:o(t[1]),alt:""}),(0,d.jsx)(k,{$side:"right",$top:`calc(5%  + ${i.mvRT})`,$gap:i.mvGapRT,$delay:2,src:o(t[2]),alt:""}),(0,d.jsx)(k,{$side:"right",$top:`calc(40% + ${i.mvRB})`,$gap:i.mvGapRB,$delay:3,src:o(t[3]),alt:""}),(0,d.jsx)(c,{alt:"ina-logo",src:"/InaLogo.png"}),(0,d.jsx)(k,{$side:"left",$top:i.shTopLT,$gap:i.shGapLT,$delay:4,src:r(a[0]),alt:""}),(0,d.jsx)(k,{$side:"left",$top:i.shTopLB,$gap:i.shGapLB,$delay:5,src:r(a[1]),alt:""}),(0,d.jsx)(k,{$side:"right",$top:i.shTopRT,$gap:i.shGapRT,$delay:6,src:r(a[2]),alt:""}),(0,d.jsx)(k,{$side:"right",$top:i.shTopRB,$gap:i.shGapRB,$delay:7,src:r(a[3]),alt:""})]}),(0,d.jsx)(m,{children:"INA'S 6TH BIRTHDAY CELEBRATION"})]}),(0,d.jsx)(f,{children:(0,d.jsxs)("h3",{children:[(0,d.jsx)("i",{className:"fa fa-chevron-down"})," Scroll down for more"," ",(0,d.jsx)("i",{className:"fa fa-chevron-down"})]})})]})},T=i.Ay.div`
  text-align: center;
  padding-top: 10px;
  padding-bottom: 10px;
  background: var(--background)
...
`;var N=a(984);const G=Array.from({length:47},(e,t)=>`valkyrie_illust_vids/val-${t+1}.mp4`),B=e=>{if(1===G.length)return G[0];let t=e;for(;t===e;){const e=Math.floor(Math.random()*G.length);t=G[e]}return t},H=()=>{const[e,t]=(0,n.useState)(()=>B()),[a,i]=(0,n.useState)(!1);(0,n.useEffect)(()=>{i(!1)},[e]);const o=(0,n.useCallback)(()=>{t(e=>B(e))},[]),r=(0,n.useCallback)(()=>{i(!0)},[]);return(0,d.jsx)(T,{children:(0,d.jsxs)(I,{children:[(0,d.jsx)(N.wA,{children:(0,d.jsxs)("div",{className:"lore-text",children:[(0,d.jsx)("hr",{}),(0,d.jsxs)("p",{children:["One day, ",(0,d.jsx)("b",{children:"Ina'nis"})," picked up a ",(0,d.jsx)("b",{children:"strange book"})," and then started to gain the power of ",(0,d.jsx)("b",{children:"controlling tentacles"}),". To her, ",(0,d.jsx)("b",{children:"tentacles"})," are just a part in her ordinary life; it has never been a big deal for her. However, her girly mind does want to get them",(0,d.jsx)("b",{children:" dressed up and stay pretty"}),"."]}),(0,d.jsxs)("p",{children:["After gaining power, she started hearing"," ",(0,d.jsx)("b",{children:"Ancient Whispers and Revelations"}),". Hence, she began her"," ",(0,d.jsx)("b",{children:"VTuber activities "})," to deliver ",(0,d.jsx)("b",{children:" random sanity checks "})," ","on humanity, as an ",(0,d.jsx)("b",{children:"ordinary girl"}),"."]}),(0,d.jsx)("hr",{})]})}),(0,d.jsxs)(R,{style:{background:a?"transparent":"var(--dark-background)"},children:[(0,d.jsx)(S,{autoPlay:!0,loop:!0,muted:!0,preload:"auto",onCanPlay:r,style:{opacity:a?1:0,transition:"opacity 0.5s ease"},children:(0,d.jsx)("source",{src:`/${e}`,type:"video/mp4"})},e),(0,d.jsx)(L,{type:"button",onClick:o,"aria-label":"Change lore video",title:"Change video",children:(0,d.jsx)("i",{className:"fa fa-refresh","aria-hidden":"true"})}),(0,d.jsx)(Y,{children:(0,d.jsx)(C,{children:"Illustration and Animation: @valkyrie_illust"})})]})]})})},D=i.Ay.div`
...
`,O=i.Ay.span`
  ...
  pointer-events: none;
  animation: ${P} 2.5s ease forwards;
  @media only screen and (max-width: 701px) {
    font-size: 1.5rem;
    letter-spacing: 1px;
    width: min-content;
  }
`,K=()=>{const[e,t]=(0,n.useState)(!1),[a,i]=(0,n.useState)(null),o=(0,n.useCallback)(()=>{t(e=>(e&&i(e=>(null!==e&&void 0!==e?e:0)+1),!e))},[]);return(0,d.jsxs)(D,{$grayscale:e,children:[(0,d.jsxs)(W,{children:[(0,d.jsx)(E,{src:"/InaInaIna.png",grayscale:e,alt:"Ina"}),null!==a&&(0,d.jsx)(O,{children:"Miraculously preserved"},a)]}),(0,d.jsxs)(F,{style:e?{filter:"grayscale(1)"}:{},children:[(0,d.jsx)("img",{alt:"WAH",src:"/WAH.png",style:e?{filter:"grayscale(1)"}:{}}),(0,d.jsx)("br",{}),"Ninomae Ina'nis",(0,d.jsx)("br",{}),"12\xb709\xb72020",(0,d.jsx)("br",{})]}),(0,d.jsx)(X,{onClick:o,children:e?"Give her an elixir of the undying":"Ina asked for this button but didn't see it last time lol"})]})},_=i.Ay.div`
  position: absolute;
  top: 50px;
  left: 10px;
  background: var(--dark-highlight);
...
`,ie=i.Ay.a`
  ...
  align-items: center;
  justify-content: center;
`;var oe=a(5402);const re=[{to:"/letters",label:"Letters for Ina"},{to:"/playlist",label:"The Ultimate Ina Playlist"},{to:"/timeline",label:"Ina's Timeline"},{to:"/takodex",label:"Takodex"},{to:"/messages",label:"Messages and Artworks"},{href:"Ina Cookbook.pdf",label:"Tako Cookbook"},{to:"/collages",label:"Takollages"},{to:"/moments",label:"Ina Moments (2024)"},{to:"/wah",label:"WAH (2024)"}],le=["Letters for Ina","The Ultimate Ina Playlist","Ina's Timeline","Messages and Artworks"],se=()=>{const[e,t]=(0,n.useState)(null),[a,i]=(0,n.useState)(""),[o,r]=(0,n.useState)(null);return(0,d.jsx)(V,{children:(0,d.jsxs)(U,{children:[(0,d.jsx)(N.wA,{children:(0,d.jsxs)("div",{className:"Menu-text",children:[(0,d.jsxs)("p",{children:["This site was developed by the ",(0,d.jsx)("b",{children:"Tentacult"})," to celebrate"," ",(0,d.jsx)("b",{children:"Ina's milestones"}),"!"]}),(0,d.jsxs)("p",{children:["This time we celebrate your ",(0,d.jsx)("b",{children:"birthday"}),"!"]}),(0,d.jsxs)("p",{children:["We've collected ",(0,d.jsx)("b",{children:"artworks and fan letters"})," from Takodachis around the world. Takos picked up pen and paper to pour their hearts out and send their love directly to you, and we are also keeping their letters here on the site for you to come back to whenever you want. We also put together the"," ",(0,d.jsx)("b",{children:"ultimate Ninomae Ina'nis playlist"})," with every single song you have ever sung over the years. The ",(0,d.jsx)("b",{children:"outfit timeline"})," ","has been updated too, with even more of your huge wardrobe on display across the years!"]}),(0,d.jsx)("p",{children:"We are so proud and extremely happy for how much you have achieved and how much love you continue to share with all of us."}),(0,d.jsxs)("p",{children:[(0,d.jsx)("b",{children:"From the bottom of our hearts, thank you so much!"}),(0,d.jsx)("br",{}),(0,d.jsx)("b",{children:"With all our love, Happy Birthday, Ina! \ud83d\udc9c\ud83d\udc19"})]}),(0,d.jsx)("sub",{children:"And Happy Anniversary, Takos!"})]})}),(0,d.jsx)(Z,{children:re.map((n,l)=>(0,d.jsxs)(q,{onMouseEnter:()=>{t(l),(e=>{r(e),setTimeout(()=>r(null),400),i(""),setTimeout(()=>{const e=oe.A[Math.floor(Math.random()*oe.A.length)];i(`/takos/${encodeURIComponent(e)}`)},120)})(l)},onMouseLeave:()=>t(null),style:{position:"relative"},children:[le.includes(n.label)&&(0,d.jsx)(_,{children:"New"}),(0,d.jsx)(Q,{className:"tako-peek",src:a,alt:"peeking tako",active:e===l&&!!a,style:{visibility:a?"visible":"hidden"}}),"to"in n?(0,d.jsx)(ne,{to:n.to,role:"button",children:(0,d.jsxs)(ee,{title:n.label,$shaking:o===l,children:[(0,d.jsx)(te,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(ae,{children:n.label})]})}):(0,d.jsx)(ie,{href:n.href,role:"button",target:"Takollages"===n.label?"_blank":void 0,rel:"Takollages"===n.label?"noopener noreferrer":void 0,children:(0,d.jsxs)(ee,{title:n.label,$shaking:o===l,children:[(0,d.jsx)(te,{src:"/cookie.png",alt:"cookie"}),(0,d.jsx)(ae,{children:n.label})]})})]},n.label))})]})})},de=60,pe=i.Ay.div`
...
`,ce=e=>{let{mirror:t,topGap:a}=e;return(0,d.jsx)(pe,{$topGap:a,children:Array(8).fill(0).map((e,a)=>(0,d.jsx)(xe,{src:"/takoflap.gif",alt:"gif",delay:-1.25*a,mirror:t,draggable:"false"},a))})};var he=a(1472),me=a(2154),ge=a(4530);const fe=e=>({src:`balloons/generic/balloon-generic-${e}.png`}),ue=e=>({src:`balloons/mv/balloon-mv-${e}.png`}),ye=e=>({src:`balloons/takos/balloon-takos-${e}.png`}),be=[ye("0"),ye("1"),ye("cookies"),ye("uhh-i-think-she-needs-help")],ve={Standard:[ue("meconopsis"),ue("violet"),ue("temari"),ue("tako8takover"),fe("purple"),fe("pink"),fe("white"),fe("yellow"),fe("fushia"),fe("orange"),fe("green"),fe("lime"),...be],Violet:[ue("violet"),fe("blue"),fe("blueagain"),fe("violet"),fe("sky"),fe("cyan"),fe("purple"),...be],Meconopsis:[ue("meconopsis"),fe("blue"),fe("blueagain"),fe("cyan"),fe("purple"),fe("sky"),fe("violet"),...be],Temari:[ue("temari"),fe("red"),fe("lightred"),fe("orange"),fe("pink"),fe("fushia"),fe("yellow"),...be],TakoTakover:[ue("tako8takover"),fe("purple"),fe("fushia"),fe("pink"),fe("violet"),fe("sky"),...be]},we=i.Ay.img`
  position: absolute;
  left: ${e=>{let{left:t}=e;return t}}vw;
  bottom: ${e=>{let{bottom:t}=e;return t}}px;
...
`,ke=i.Ay.div`
  ...
  overflow: visible;
  overflow-x: hidden;
`,je=()=>{const[e,t]=(0,n.useState)([]),a=(0,n.useRef)(null),{theme:i}=(0,u.D)();return(0,n.useEffect)(()=>(a.current=setInterval(()=>{const e=ve[i],a=Math.floor(2*Math.random())+1,n=document.documentElement.scrollHeight,o=[];for(let t=0;t<a;t++)if(Math.random()<.96){const a=e[Math.floor(Math.random()*e.length)];o.push({key:Date.now()+Math.random()+t,left:88*Math.random(),src:a.src,bottom:Math.random()*n,createdAt:Date.now(),heightScale:.6*Math.random()+.4,swayOffset:(30*Math.random()+10)*(Math.random()<.5?1:-1)})}o.length>0&&t(e=>[...e,...o])},2e3),()=>{a.current&&clearInterval(a.current)}),[i]),(0,n.useEffect)(()=>{const e=setInterval(()=>{t(e=>e.filter(e=>Date.now()-e.createdAt<2e4))},2e3);return()=>clearInterval(e)},[]),(0,d.jsx)(ke,{children:e.map(e=>(0,d.jsx)(we,{left:e.left,bottom:e.bottom,swayOffset:e.swayOffset,$heightScale:e.heightScale,src:`/${e.src}`,alt:"floating balloon"},e.key))})},$e=i.Ay.div`
  position: relative;
  width: 100%;
  max-width: 100vw;
  overflow-x: hidden;
...
`}}]);
//# sourceMappingURL=421.09995f5a.chunk.js.map